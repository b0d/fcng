...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog21.description"),
	};
}

export default async function Blog21({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog21.beforeModelName")}
				sendt={t("Blog21.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog21.mainh1")}</h1>
