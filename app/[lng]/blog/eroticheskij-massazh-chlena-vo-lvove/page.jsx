...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog22.description"),
	};
}

export default async function Blog22({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog22.beforeModelName")}
				sendt={t("Blog22.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog22.mainh1")}</h1>
