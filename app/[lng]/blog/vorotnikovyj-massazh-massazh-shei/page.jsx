...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog10.description"),
	};
}

export default async function Blog10({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog10.beforeModelName")}
				sendt={t("Blog10.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog10.mainh1")}</h1>
