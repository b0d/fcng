...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog15.description"),
	};
}

export default async function Blog15({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog15.beforeModelName")}
				sendt={t("Blog15.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog15.mainh1")}</h1>
