...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog11.description"),
	};
}

export default async function Blog11({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog11.beforeModelName")}
				sendt={t("Blog11.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog11.mainh1")}</h1>
