...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog12.description"),
	};
}

export default async function Blog12({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog12.beforeModelName")}
				sendt={t("Blog12.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog12.mainh1")}</h1>
