...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog14.description"),
	};
}

export default async function Blog14({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog14.beforeModelName")}
				sendt={t("Blog14.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog14.mainh1")}</h1>
