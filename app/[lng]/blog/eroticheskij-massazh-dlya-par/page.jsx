...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog19.description"),
	};
}

export default async function Blog19({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog19.beforeModelName")}
				sendt={t("Blog19.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog19.mainh1")}</h1>
