...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog16.description"),
	};
}

export default async function Blog16({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog16.beforeModelName")}
				sendt={t("Blog16.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog16.mainh1")}</h1>
