...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog13.description"),
	};
}

export default async function Blog13({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog13.beforeModelName")}
				sendt={t("Blog13.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog13.mainh1")}</h1>
