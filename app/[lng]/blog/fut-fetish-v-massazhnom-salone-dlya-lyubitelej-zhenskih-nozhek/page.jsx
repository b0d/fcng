...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog18.description"),
	};
}

export default async function Blog18({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog18.beforeModelName")}
				sendt={t("Blog18.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog18.mainh1")}</h1>
