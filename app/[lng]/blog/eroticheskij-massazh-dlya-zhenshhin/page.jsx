...
export async function generateMetadata({ params }) {
	...
	return {
		...
		description: t("Blog20.description"),
	};
}

export default async function Blog20({ params }) {
	const { lng } = await params;
	const { t } = await useTranslation(lng);
	...
	return (
		<div>
			<Header lng={lng} />
			<BreadCrumbs
				getcontent={t("Blog20.beforeModelName")}
				sendt={t("Blog20.mainh1")}
				lng={lng}
			/>
			<section className='container'>
				<h1>{t("Blog20.mainh1")}</h1>
